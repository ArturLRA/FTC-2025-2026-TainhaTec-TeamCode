...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 77.10; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -24.61; // x position of the perpendicular encoder (in tick units)
    }
