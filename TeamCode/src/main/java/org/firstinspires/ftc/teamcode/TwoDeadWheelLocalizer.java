...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 402.0; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -603.0; // x position of the perpendicular encoder (in tick units)
    }
