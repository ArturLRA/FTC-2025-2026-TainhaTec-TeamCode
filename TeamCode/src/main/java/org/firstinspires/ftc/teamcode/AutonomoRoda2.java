...
@Autonomous(name = "AutonomoRoda2", group = "autonomous")
public class AutonomoRoda2 extends LinearOpMode {
    ...
    public void turn(double targetAngle, double maxPower) {
        ...
        while (opModeIsActive() && attempt < maxAttempts) {
            ...
            while (opModeIsActive()) {
                ...
                if (elapsedTime > maxTimePerAttempt) {
                    telemetry.addData("Timeout", "Limite de tempo atingido");
                    telemetry.update();
                    break;
                }

                double currentYaw = imu.getRobotYawPitchRollAngles().getYaw(AngleUnit.DEGREES);
                double error = angleWrap(currentYaw - targetAngle);
                ...
                telemetry.addData("Tempo decorrido", elapsedTime);
                telemetry.update();
