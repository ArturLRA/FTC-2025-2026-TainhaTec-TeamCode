...
public final class TankDrive {
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "front_left_drive"), hardwareMap.get(DcMotorEx.class, "back_left_drive"));
        rightMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "front_right_drive"), hardwareMap.get(DcMotorEx.class, "back_right_drive"));
