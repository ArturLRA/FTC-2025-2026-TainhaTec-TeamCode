...
@Config
@Autonomous(name = "AutonomoVermelho", group = "Autonomous")
public class AutonomoVermelho extends LinearOpMode {
    ...
    public class AutoAimAction implements Action {
        ...
        private static final double ALIGNMENT_THRESHOLD_DEGREES = 0.5;
        ...
        public boolean run(@NonNull TelemetryPacket packet) {
            ...
            double visionHeading = -Math.toRadians(detection.ftcPose.bearing);
            Pose2d currentPose = drive.localizer.getPose();
            drive.localizer.setPose(new Pose2d(currentPose.position, visionHeading));
            ...
            double derivative = (currentError - lastError) / loopTime;
            ...
            packet.put("AutoAim Erro", currentError);
