...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 196.85; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -164.04; // x position of the perpendicular encoder (in tick units)
    }
